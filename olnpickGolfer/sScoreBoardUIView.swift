            ...
            struct EachScoreSubView: View {
                ...
                var body: some View{
                    VStack(){
                        ...
                        .frame(width:Const.medalbuttonSize , height: Const.medalbuttonSize, alignment: /*@START_MENU_TOKEN@*/.center/*@END_MENU_TOKEN@*/)
        ...
        struct ScoreBoardUIView_Previews: PreviewProvider {
            static var previews: some View {
                sScoreBoardUIView(viewCode: .constant(""))
            }
        }
